        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <h2 class="h4 mb-0">Create New Recipe</h2>
                </div>
                    ...
                    <form action="{{ route('recipes.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-sm-4">
                                ...
                                <input type="number" name="prep_time" id="prep_time" min="0"
                                       ...
                                       value="{{ old('prep_time', 0) }}" required>
                                @error('prep_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-sm-4">
                                ...
                                <input type="number" name="cook_time" id="cook_time" min="0"
                                       ...
                                       value="{{ old('cook_time', 0) }}" required>
                                @error('cook_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            <label for="image" class="form-label fw-semibold">
                                Recipe Image <span class="text-danger">*</span>
                            </label>
